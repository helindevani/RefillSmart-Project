...
namespace back_end.Migrations
{
    ...
    [Migration("20240501123248_NewUpdatation1")]
    partial class NewUpdatation1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("back_end.Domain.Entities.GasBooking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BookingId = new Guid("096f0943-dcb5-4f2f-be48-de30b9e184e0"),
                            BookingDate = new DateTime(2024, 5, 1, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(5074),
                            ConnectionNo = new Guid("e3f3b30b-b841-4196-a665-f3eef01d7e58"),
                            CreateDate = new DateTime(2024, 5, 1, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(5111),
                            CustomerAddress = "123 Main Street",
                            CustomerName = "John Doe",
                            CustomerPhoneNumber = "1234567890",
                            DeliveryDate = new DateTime(2024, 5, 8, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(5080),
                            Status = 0,
                            UpdateDate = new DateTime(2024, 5, 1, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(5112)
                        });
                });
            ...
            modelBuilder.Entity("back_end.Domain.Entities.NewConnectionForm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AppliedDate = new DateTime(2024, 5, 1, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(4866),
                            City = "Anytown",
                            ConnectionStatus = 0,
                            CreateDate = new DateTime(2024, 5, 1, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(4871),
                            ...
                            UpdateDate = new DateTime(2024, 5, 1, 12, 32, 47, 783, DateTimeKind.Utc).AddTicks(4872),
